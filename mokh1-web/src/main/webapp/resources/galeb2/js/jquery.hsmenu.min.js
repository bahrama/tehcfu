				...
				.each(function() {
							...
							.click(
									function() {
										...
										if (a($reveal).hasClass("fadeInUp")) {
											a($reveal).removeClass("fadeInUp")
													.fadeOut()
										} else {
											a($reveal).fadeIn().addClass(
													"fadeInUp")
										}
										a($allRevealable).not($reveal)
												.removeClass(
														"fadeInUp ripple-out")
												.fadeOut()
									});
					...
					a(".search-trigger").click(
							function() {
								a(this).toggleClass("ripple-out");
								a(this).find(".zmdi")
										.removeClass("zmdi-search").addClass(
												"zmdi-close");
						...
						a(window)
								.click(
										function(l) {
											if (a(l.target)
													.closest(
															".more-trigger, .grid-trigger,  .user-penal, .grid-items, .menu-trigger, .hs-navigation, .hs-user, .user-info").length) {
												return
											}
											a(
													".user-penal, .grid-items, .user-info")
													.fadeOut().removeClass(
															"fadeInUp");
					...
					if (c.navControls == true) {
						...
						d = h();
						f = h();
						a(d).html("<i class='zmdi zmdi-unfold-more'></i>")
								.addClass("nav-fixed").appendTo(i);
						a(f).addClass("nav-full").html(
								"<i class='zmdi zmdi-crop-free'></i>")
								.appendTo(i);
						a(i).addClass("nav-controls").prependTo(
								".hs-navigation");
						a(".nav-fixed")
								.on(
										"click",
