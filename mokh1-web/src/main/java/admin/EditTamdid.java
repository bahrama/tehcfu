...
@Named
@SessionScoped
public class EditTamdid implements Serializable {
	...
	private TamdidEntity tamdidEntity=new TamdidEntity();
	
	

	public TamdidEntity getTamdidEntity() {
		return tamdidEntity;
	}



	public void setTamdidEntity(TamdidEntity tamdidEntity) {
		this.tamdidEntity = tamdidEntity;
	}



	public List<TamdidEntity> findAllTamdid(){
		return tamdidServiceLocal.findAllTamdid();
	}
	
	public TamdidEntity findTamdidById(long id) {
		this.tamdidEntity=tamdidServiceLocal.findTamdidById(id);
		return this.tamdidEntity;
	}
