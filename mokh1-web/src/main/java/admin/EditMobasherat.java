...
@Named
@SessionScoped
public class EditMobasherat implements Serializable {
	...
	public EditMobasherat() {
		// TODO Auto-generated constructor stub
	}
	@Inject
	private MobasheratServiceLocal mobasheratServiceLocal;
	
	private MobasheratEntity mobasheratEntity=new MobasheratEntity();
	
	
	
	public MobasheratEntity getMobasheratEntity() {
		return mobasheratEntity;
	}



	public void setMobasheratEntity(MobasheratEntity mobasheratEntity) {
		this.mobasheratEntity = mobasheratEntity;
	}



	public List<MobasheratEntity> findAllMobasherat() {
		return mobasheratServiceLocal.findAllMobasherat();
	}
	
	
	public MobasheratEntity findMobasheratById(long id) {
		this.mobasheratEntity=mobasheratServiceLocal.findMobasheratById(id);
		return this.mobasheratEntity;
	}
