...
public class ProductDao implements ProductDaoLocal {
    ...
    public ProductEntity findProductEntityById(long productId) {
    	ProductEntity productEntity =(ProductEntity) entityManager.createNamedQuery("findByProductEntityId").setParameter("v_productId", productId).getSingleResult();
    	if(productEntity.getProductType().equals("AyeneVConsole"))
    		this.productDetail = findAyeneVConsoleById(productId);
    	if(productEntity.getProductType().equals("DarbChobi"))
    		this.productDetail = findDarbChobiById(productId);
    	if(productEntity.getProductType().equals("DarbZedSergat"))
    		this.productDetail =  findDarbZedSergatById(productId);
    	if(productEntity.getProductType().equals("GhabAx"))
    		this.productDetail =  findGhabAxById(productId);
    	if(productEntity.getProductType().equals("Kabinet"))
    		this.productDetail =  findKabinetById(productId);
    	...
    	if(productEntity.getProductType().equals("Mdf"))
    		this.productDetail =  findMdfId(productId);
    	if(productEntity.getProductType().equals("MizAsali"))
    		this.productDetail =  findMizAsaliById(productId);
    	if(productEntity.getProductType().equals("MizEdari"))
    		this.productDetail =  findMizEdariById(productId);
    	if(productEntity.getProductType().equals("MizJeloMobli"))
    		this.productDetail =  findMizJeloMobliById(productId);
    	if(productEntity.getProductType().equals("MizNaharKhori"))
    		this.productDetail =  findMizNaharKhoriById(productId);
    	if(productEntity.getProductType().equals("MizTv"))
    		this.productDetail =  findMizTvById(productId);
    	if(productEntity.getProductType().equals("Moblman"))
    		this.productDetail =  findMoblmanById(productId);
    	if(productEntity.getProductType().equals("Mojasame"))
    		this.productDetail =  findMojasameById(productId);
    	if(productEntity.getProductType().equals("Monabat"))
    		this.productDetail =  findMonabatById(productId);
    	if(productEntity.getProductType().equals("Panjare"))
    		this.productDetail =  findPanjareById(productId);
    	if(productEntity.getProductType().equals("Partition"))
    		this.productDetail =  findPartitionById(productId);
    	if(productEntity.getProductType().equals("SandaliEdari"))
    		this.productDetail =  findSandaliEdariById(productId);
    	if(productEntity.getProductType().equals("ServiceKhab1"))
    		this.productDetail =  findServiceKhab1ById(productId);
    	if(productEntity.getProductType().equals("ServiceKhab2"))
    		this.productDetail =  findServiceKhab2ById(productId);
    ...
    public Map<ProductEntity, Object> findAllProductBySeller2(MoblEntity moblEntity){
    	Map<ProductEntity, Object> map = new HashMap<ProductEntity, Object>();
    	for (ProductEntity proEntity : findAllProductEntityBySeller(moblEntity)) {
        	if(proEntity.getProductType().equals("AyeneVConsole"))
        		map.put(proEntity, findAyeneVConsoleById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("DarbChobi"))
        		map.put(proEntity, findDarbChobiById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("DarbZedSergat"))
        		map.put(proEntity, findDarbZedSergatById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("GhabAx"))
        		map.put(proEntity, findGhabAxById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Kabinet"))
        		map.put(proEntity, findKabinetById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("KomodBoofeKetabkhaneJakafshi"))
        		map.put(proEntity, findKomodBoofeKetabkhaneJakafshiById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Mdf"))
        		map.put(proEntity, findMdfId(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("MizAsali"))
        		map.put(proEntity, findMizAsaliById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("MizEdari"))
        		map.put(proEntity, findMizEdariById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("MizJeloMobli"))
        		map.put(proEntity, findMizJeloMobliById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("MizNaharKhori"))
        		map.put(proEntity, findMizNaharKhoriById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("MizTv"))
        		map.put(proEntity, findMizTvById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Moblman"))
        		map.put(proEntity, findMoblmanById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Mojasame"))
        		map.put(proEntity, findMojasameById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Monabat"))
        		map.put(proEntity, findMonabatById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Panjare"))
        		map.put(proEntity, findPanjareById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("Partition"))
        		map.put(proEntity, findPartitionById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("SandaliEdari"))
        		map.put(proEntity, findSandaliEdariById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("ServiceKhab1"))
        		map.put(proEntity, findServiceKhab1ById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("ServiceKhab2"))
        		map.put(proEntity, findServiceKhab2ById(proEntity.getProductId()));
        	if(proEntity.getProductType().equals("ServiceKhabKodak"))
        		map.put(proEntity, findServiceKhabKodakById(proEntity.getProductId()));
		}    	
