...
a persistence unit "mokh1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "mokh1\pom.xml":
...
artifacts ("mokh1-ejb.jar" and "mokh1-web.war") are already built. You can build
